                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div>
                                    ...
                                    <form action="/tambahpelanggaran" method="post">
                                    <?= csrf_field() ?>

                                        <div class="form-group
                                        ">
                                            <label for="jenis">Jenis Pelanggaran</label>
                                            <input type="text" class="form-control" id="jenis" name="jenis" placeholder="Masukkan Jenis Pelanggaran" required>
                                        </div>
                                        <div class="form-group
                                        ">
                    ...
                    <div class="modal-dialog modal-dialog-scrollable"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="modal-footer">
                                    <div class="d-flex justify-content-end">
                                        <a href="https://docs.google.com/spreadsheets/d/1Yx0p1XJStQ8RPUHbr3VpoVuAn4zwWM-xckxbrE9BoXU/edit#gid=1271295487" target="_blank"  class="btn btn-primary me-1 mb-1">Submit</a>                                        
                                        <button class="btn btn-secondary ml-1 mb-1" data-dismiss="modal"
                                        aria-label="Close"
                                            >Kembali</button>
                                    </div>
